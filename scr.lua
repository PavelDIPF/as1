...
local function Hide(notify: boolean?)
	...
	if notify then
		if useMobilePrompt then 
			RayfieldLibrary:Notify({Title = "Интерфейс Скрыт", Content = "Интерфейс был скрыт, вы можете отобразить интерфейс, нажав "Показать CasualScript".", Duration = 7, Image = 4400697855})
		else
			RayfieldLibrary:Notify({Title = "Интерфейс Скрыт", Content = "Интерфейс был скрыт, вы можете показать интерфейс, нажав K.", Duration = 7, Image = 4400697855})
		end
	end
